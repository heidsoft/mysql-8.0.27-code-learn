...
%global src_dir               %{src_base}-8.0.27
...
Vendor:         %{mysql_vendor}
Source10:       https://boostorg.jfrog.io/artifactory/main/release/1.73.0/source/boost_1_73_0.tar.bz2
...
%{?sles12:BuildRequires: gcc10 gcc10-c++}
%{?sles15:BuildRequires: gcc9 gcc9-c++}
...
%global _privatelibs libprotobuf.*|libmysqlharness\.so.*|libmysqlharness_stdx\.so.*|libmysqlharness_tls\.so.*|libmysqlrouter\.so\..*|libmysqlrouter_.*\.so\..*|libfido2.*
...
%attr(755, root, root) %{_libdir}/mysql/private/libfido2.so.1.5.0
