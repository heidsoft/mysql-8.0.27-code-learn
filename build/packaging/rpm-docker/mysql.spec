...
Source1:        https://boostorg.jfrog.io/artifactory/main/release/1.73.0/source/boost_1_73_0.tar.bz2
%if 0%{?rhel} >= 8
...
for f in innochecksum ibd2sdi myisamchk myisam_ftdump myisamlog myisampack \
         ...
         comp_err perror lz4_decompress zlib_decompress mysql_keyring_encryption_test; do
